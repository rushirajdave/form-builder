...
function FormRenderFn(e, t) {
    ...
    a.getElement = function() {
        ...
        switch (i.type) {            
            case "textarea":
            case "rich-text":
                delete i.type, delete i.value, t = n + "<textarea " + f + "></textarea>";
                break;
            case "select":
                i.type = i.type.replace("-group", ""), d.length && d.each(function(e, t) {
                    e = e;
                    var n = a.parseAttrs(t.attributes),
                        o = a.attrString(n);
                    r += "<option " + o + ">" + t.textContent + "</option>"
                }), t = n + "<select " + f + ">" + r + "</select>";
                break;
            case "checkbox-group":
            case "radio-group":
                var p = !1;
                i.type = i.type.replace("-group", ""), i.other && (delete i.other, p = !0), d.length && ! function() {
                    ...
                    if (d.each(function(n, o) {
                        ...
                        var n = {
                            id: i.id + "-other",
                            name: e,
                            "class": i["class"] + " other-option"
                        };
                        t = a.attrString($.extend({}, i, n)), r += "<input " + t + ' /> <label for="' + n.id + '">' + o.label.other + '</label> <input type="text" data-other-id="' + n.id + '" id="' + n.id + '-value" style="display:none;" />'
                    }
            ...
            case "autocomplete":
                ...
                break;
            case "color":
                t = n + " <input " + f + "> " + o.label.selectColor;
                break;
            case "button":
            case "submit":
                t = "<button " + f + ">" + u + "</button>";
                break;
            case "checkbox":
                t = "<input " + f + "> " + n, i.toggle && setTimeout(function() {
                    $(document.getElementById(i.id)).kcToggle()
                }, 100);
                break;
            case "rating5star":
                t = u+"<" + i.type + " " + f + ">" + add_rate(5); + "</" + i.type + ">"
                break;
            case "rating10star":
                t = u+"<" + i.type + " " + f + ">" + add_rate(10); + "</" + i.type + ">"
                break;
            case "sortable-field":
                var p = !1;
                i.type = i.type, i.other && (delete i.other, p = !0), d.length && ! function() {
                    var e = "checkbox" === i.type ? i.name + "[]" : i.name,
                        t = void 0;
                    if (d.each(function(n, o) {
                            var l = $.extend({}, i, a.parseAttrs(o.attributes));
                            l.selected && (delete l.selected, l.checked = null), l.name = e, l.id = i.id + "-" + n, t = a.attrString(l), r += "<li " + t + ' > <label for="' + l.id + '">' + o.textContent + "</label></li><br>"
                        }), p) {
                        var n = {
                            id: i.id + "-other",
                            name: e,
                        ...
                        t = a.attrString($.extend({}, i, n)), r += "<li " + t + ' > <label for="' + n.id + '">' + o.label.other + '</label></li> <input type="text" data-other-id="' + n.id + '" id="' + n.id + '-value" style="display:none;" />'
                    }
                }(), t = n + '<ul class="' + i.type + '-group">' + r + "</ul>";
                break;
            default:
                t = "<" + i.type + " " + f + ">" + u + "</" + i.type + ">"
        }
        ...
        return e = n[e] || e, t = t ? window.JSON.stringify(t) : !1, t = t ? "=" + t : "", {
            name: e,
            value: t
        }
    ...
    var i = function() {
        ...
        s = [],
        c = $.parseXML(o.formData),
        d = $("field", c);
    if (d.length) d.each(function(e, t) {
        e = e, s.push(a.fieldRender(t))
    });
    else {
        var u = a.markup("div", o.label.noFormData, {
    ...
    if (o.render) {
        if (o.container) {
            ...
            p ? (p.emptyContainer(), p.appendFormFields(s)) : (p = a.markup("div", s, {
                className: "rendered-form"
            }), t.parentNode.insertBefore(p, t.nextSibling), t.style.display = "none", t.setAttribute("disabled", "disabled"))
        }
